...
function nextSlide() {
  currentSlide = (currentSlide + 1) % slides.length // Calcula o índice do próximo
...
function prevSlide() {
  currentSlide = (currentSlide - 1 + slides.length ) % slides.length // Calcula o índice do próximo
